...
namespace SpartaTodo.Controllers
{
    public class TodoController : Controller
    {
        ...
        public TodoController(SpataTodoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            todos.ForEach(t => todosViewModels.Add(Utils.TodoToViewModel(t)));
        ...
        //        {
        //            return Problem("Entity set 'SpataTodoContext.Todos'  is null.");
        //        }
        //        var todo = await _context.Todos.FindAsync(id);
        //        if (todo != null)
        //        {
